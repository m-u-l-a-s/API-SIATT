  ...
  return (
    <div className="relative inline-block text-left" ref={timePickerRef}>
      <input
        type="text"
        readOnly
        className="w-24 rounded-md border border-gray-300 bg-white text-gray-900 px-3 py-2 placeholder-gray-400 shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
        value={`${hour}:${minute}`}

    ...
    return (
        <div>
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                <div className="flex items-center justify-between px-6 py-5 bg-gray-700">
                ...
                <div id="myModal" className="modal hidden fixed inset-0 items-center justify-center z-50">
                    ...
                    <div className="modal-container bg-white rounded shadow-lg z-50 overflow-y-auto max-h-20">
                        <div className="modal-content py-4 text-left px-6">
                            <div className="flex justify-between items-center pb-3">
                                <p className="text-2xl font-bold">Selected Date</p>
                                <button onClick={hideModal} className="modal-close px-4 py-1 rounded-full bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring">
                                    ✕
                                </button>
                            </div>
